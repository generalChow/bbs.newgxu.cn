...
(new LetsKillIE6()).init({
	...
	cssUrl		:'//127.0.0.1:8080/css/10_years_index/kill-ie6.css',
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><p>' + 
				'您正在使用 Internet Explorer 6 浏览网页，如果您<strong style="color: red;">转换到另一款浏览器</strong>，可以获得更好的网站浏览体验。<a href="http://bbs.newgxu.cn/topic.yws?forumId=1&topicId=424088" target="_blank">详情请猛击</a>' +
				'</p><div style="clear:both;"></div><p class="letskillie6-browsers"><a rel="nofollow" class="letskillie6-firefox" href="download/Firefox_12.zip">Firefox (解压缩后双击firefox.exe即可使用 20M）</a><a rel="nofollow" class="letskillie6-chrome" href="download/ChromeStandaloneSetup.exe">Chrome (双击安装运行后即可使用 25M)</a><div style="clear:both;"></div></p><p class="letskillie6-meta">享受更美好的上网环境！下载速度很给力哦~！感谢大家支持雨无声~！</p></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-r2"></div><div class="letskillie6-r4"></div>'
});
