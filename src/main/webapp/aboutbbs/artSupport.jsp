...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
  ...
  <tr>
    ...
    <td align="center" valign="top" bgcolor="#FFFBE0" class="center_c"><table width="100%" height="35"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" class="xlogo2">美术支持</td>
        </tr>
      </table>
        <table width="857" height="62" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
          ...
          <tr>
            <td height="36" colspan="3" class="list_title">&nbsp; 美术支持</td>
          </tr>
      </table>
      <table width="95%" height="20"  border="0" align="center" cellpadding="0" cellspacing="0" class="list_bian2">
          <tr>
            <td>广西大学雨无声网站及论坛美术支持由雨无声网站技术部提供。详情请关注雨无声技术部博客<a href="http://newgxu.cn/SuperTeam/" target="_blank">http://newgxu.cn/SuperTeam/</a> <br>本网站中特有的图形、标志、页面风格、编排方式、程序等以及注明&quot;来源：雨无声网站&quot;的所有文字、图片和音视频资料，版权均属雨无声网站所有，任何媒体、网站或个人未经本网协议授权不得转载、链接、转贴或以其他方式复制发布/发表，违者本网将依法追究责任。<br><br> <p class="list_body"><br></p></td>
          </tr>
        </table>
      <table width="857" height="62" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
          <tr>
