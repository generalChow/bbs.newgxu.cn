      ...
      <tr>
        <td colspan="4" align="center"><table  border="1" align="center" bordercolor="#CCCCCC" style="border-collapse:collapse">
            ...
            <tr>
			  ...
			  %>
              <td align="center"<% if(days[j]!="" && Integer.parseInt(days[j])==day){out.print("bgcolor=\"#C1E0FF\" ");} else {if(days[j]!=""){out.print("onmouseover=\"this.bgColor='#DEE3EF'\"; onmouseout=\"this.bgColor='#FFFFFF'\";");}}%>><a href="viewdiary.jsp" target="content">
                <%if(days[j]!="" && Integer.parseInt(days[j])==day){out.print("<strong><font color=red>"+outDate+"</font></strong>");} else {out.print(outDate);}%>
              </a></td>
              <%}%>
            </tr>
            <%}%>
