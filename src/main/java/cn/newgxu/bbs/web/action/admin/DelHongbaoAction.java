 ...
 */
public class DelHongbaoAction extends AbstractBaseAction {
	...
	public String execute() throws Exception {
		...
		response("{\"statusCode\":\"200\", \"message\":\"红包成功删除\", \"navTabId\":\"hongbao\",\"rel\":\"\", \"callbackType\":\"\",\"forwardUrl\":\"hongbao.yws\"}");
		return null;
		/*
